...
firstCharacter = getFirstCharacter[0][:1]
...
replacedString = replaceMe.replace("John", "Michael", 2)
...
testString2 = testString2.replace("You", "you")
testString2 = testString2.replace("I", "i")
